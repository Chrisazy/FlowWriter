    ...
    function load(view) {
        ...
        view_api.setToolbar(
            ...
            widget_api.button({
                text: lion('tbTest'),
                click: function () {
                    dlg(view, 'testDlg', 'This is where you could create a packet');
                }
            }),
            def_api.tbSeparator(),
            widget_api.button({
                ...
                text: lion('tbDeploy'),
                click: function () {
                    dlg(view, 'deployDlg', 'This is where you could deploy a flow table');
                }
            })
        );
